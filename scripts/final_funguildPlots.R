...
#sigOTUs$sigOtuOneToOne <- list(any = Reduce(union, lapply(speciesFDRmatrices, rownames)))
...
write.csv(allRes, file.path(eDir, "summary_onlySignificant_FDR.csv"), row.names = FALSE)
